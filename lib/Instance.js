    ...
    require("is-reachable")(this.url).then(function (reachable) {
        ...
        if (reachable) {
            if (!wasUp && !firstCheck) {
                ...
                _this.downFromDate = null;
                _this.onUp.call(_this);
                _this.runDefaultJob();
            }
            _this.wasUpDate = moment();
        } else {
            if (wasUp) {
                _this.downFromDate = moment();
            }
            if (firstCheck || wasUp) {
...
var Instance = function () {
    ...
    _createClass(Instance, [{
        ...
        key: 'getUpDateFormatted',
        value: function getUpDateFormatted() {
        ...
        key: 'getDownDateFormatted',
        value: function getDownDateFormatted() {
            if (this.isDown()) {
